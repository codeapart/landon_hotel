...
class BookingController extends Controller
{
    ...
    {
        $bookings = Booking::with(['room.roomType', 'users:name'])->paginate(4);
    ...
    public function store(Request $request)
    {
        ...
        //$user = $booking->users()->create(['name' => 'test']); //creating a new user & attaching that user to a booking record
